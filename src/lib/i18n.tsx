...
const dictionaries: Record<Lang, Dict> = {
  EN: {
    ...
    "process.title.b": "4-Step",
    "process.title.c": "Process",
    "process.subtitle": "We've streamlined our process to get your certified translation to you as fast as possible without compromising on quality.",
    "process.s1.t": "Upload your Document",
    "process.s1.d": "Scan or take a photo of your document and upload it securely.",
    "process.s2.t": "Translator gets Assigned",
    "process.s2.d": "Our certified human translators work on your documents immediately.",
    "process.s3.t": "Review & Approve",
    "process.s3.d": "Receive your translation, then provide feedback or approve for final delivery.",
    "process.s4.t": "Receive & Download",
    "process.s4.d": "Get your high-quality certified translation via email, usually within 48 hours.",
    "process.cta": "Order your Online Translation",
    "process.stat.langs": "Languages",
    "process.stat.acc": "Acceptance Rate",
    "process.stat.turn": "Avg. Turnaround",
    // Cant find styled
    "cantfind.title2": "Can't find your Document?",
    "cantfind.sub2": "Your language or document type not listed?\nWe handle all types of official documents in over 120 languages.",
    ...
    "services.s1.d": "Officially accepted by every German authority.",
    "services.s2.t": "Notarization",
    "services.s2.d": "Additional notary stamp for legal proceedings.",
    "services.s3.t": "Express Translation",
    "services.s3.d": "Same-day or 24-hour delivery for tight deadlines.",
    "services.s4.t": "Hard Copy Delivery",
    "services.s4.d": "Original signed copy by tracked post.",
    "services.s5.t": "Specialized Translation",
    "services.s5.d": "Medical, legal, technical & academic experts.",
    "services.s6.t": "Business Translation",
    "services.s6.d": "Bulk solutions for companies, firms & universities.",
...
"why.ctabar": "Ready to have your document translated?",
  ...
  DE: {
    ...
    "process.kicker": "So funktioniert's",
    "process.title.a": "Einfacher",
    "process.title.b": "4-Schritte",
    "process.title.c": "Prozess",
    "process.subtitle": "Wir haben unseren Prozess optimiert, um Ihre beglaubigte Übersetzung so schnell wie möglich zu liefern — ohne Kompromisse bei der Qualität.",
    "process.s1.t": "Dokument hochladen",
    "process.s1.d": "Scannen oder fotografieren Sie Ihr Dokument und laden Sie es sicher hoch.",
    "process.s2.t": "Übersetzer wird zugewiesen",
    "process.s2.d": "Unsere zertifizierten Übersetzer beginnen sofort mit Ihrem Dokument.",
    "process.s3.t": "Prüfen & freigeben",
    ...
    "cantfind.title": "Ihr Dokument nicht gefunden?",
    "cantfind.sub": "Kein Problem. Wir übersetzen alle Dokumentenarten. Kontaktieren Sie uns und wir helfen Ihnen sofort.",
    "cantfind.cta": "Kontakt aufnehmen",

    "services.kicker": "Unsere Dienstleistungen",
    "services.title": "Unsere Dienstleistungen",
    "services.subtitle": "Professionelle Übersetzungslösungen für jeden Bedarf.",
    "services.learn": "Mehr erfahren",
    "services.s1.t": "Beglaubigte Übersetzung",
    "services.s1.d": "Professionelle beglaubigte Übersetzungen, anerkannt von allen deutschen Behörden inkl. Ausländerbehörde, Standesamt, BAMF und Gerichten.",
    "services.s2.t": "Notarielle Beglaubigung",
    "services.s2.d": "Zusätzliche notarielle Beglaubigung für Dokumente, die einen offiziellen Notarstempel für rechtliche Verfahren benötigen.",
    "services.s3.t": "Express-Übersetzung",
    "services.s3.d": "24-Stunden- und Same-Day-Übersetzungen für dringende Fristen und kurzfristige Einreichungen.",
    "services.s4.t": "Gedruckte Kopie",
    "services.s4.d": "Physische beglaubigte Übersetzung per Post mit Sendungsverfolgung — überall in Deutschland.",
    "services.s5.t": "Fachübersetzung",
    "services.s5.d": "Experten-Übersetzungen für medizinische, juristische, technische und akademische Dokumente mit Fachexpertise.",
    "services.s6.t": "Firmenübersetzungen",
    "services.s6.d": "Bulk-Übersetzungslösungen für Unternehmen, Kanzleien, Personalabteilungen und Universitäten.",
    ...
    "why.c2.d": "Schnelle, zuverlässige Lieferung ohne Qualitätskompromisse. Express- und Eilaufträge auf Anfrage verfügbar.",
    "why.c3.t": "Zertifizierte Übersetzer",
    "why.c3.d": "Alle unsere Übersetzer sind staatlich anerkannt, nach ISO 17100 zertifiziert und haben jahrelange Erfahrung mit offiziellen Dokumenten.",
    "why.c4.t": "Höchste Datensicherheit",
    "why.c4.d": "Ihre sensiblen Dokumente werden mit 256-Bit-Verschlüsselung geschützt. ISO 27001 zertifiziert. Alle Dokumente werden nach 30 Tagen sicher gelöscht.",
    "why.c5.t": "Transparente Preise",
    "why.c5.d": "Keine versteckten Gebühren. €24 pro Seite, alles inklusive. Sie wissen genau, was Sie bezahlen, bevor Sie bestellen.",
    "why.c6.t": "Persönlicher Support",
    "why.c6.d": "Unser Team ist per E-Mail und WhatsApp erreichbar. Wir antworten innerhalb einer Stunde und begleiten Sie durch den gesamten Prozess.",
