...
const dictionaries: Record<Lang, Dict> = {
  ...
  DE: {
    ...
    "process.s1.d": "Scan oder Foto Ihres Dokuments — 100% DSGVO-konforme Datenübertragung.",
    "process.s2.t": "Festpreis erhalten & bezahlen",
    "process.s2.d": "Sie bekommen sofort einen verbindlichen Festpreis. Sicher zahlen per SEPA, Kreditkarte oder PayPal.",
    "process.s3.t": "Beglaubigte Übersetzung erhalten",
    "process.s3.d": "Digitales PDF in 24 Stunden, Original mit Stempel & Unterschrift per Einschreiben.",
